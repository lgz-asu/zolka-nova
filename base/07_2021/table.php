...
<header class="header">
    ...
    <a class="date-table" href="http://192.168.23.43:8080/zolka-nova/main.php">
...
<div class="table-base">
        ...
        <a class="table-base__item-mod" href="http://192.168.23.43:8080/zolka-nova/base/07_2021/table.php"> Июль </a>
        <a class="table-base__item" href="http://192.168.23.43:8080/zolka-nova/base/08_2021/table.php"> Август </a>
        <a class="table-base__item" href="http://192.168.23.43:8080/zolka-nova/base/09_2021/table.php"> Сентябрь </a>
    ...
    <table>
        <tr class="table-raw__tr">
            <th><a class="new-part" href="#popup1">Нов. партия</a></th>
            <th>Тип сырья</th>
            <th>Начало золки</th>
            <th>Перезолка-1</th>
            <th>Перезолка-2</th>
            ...
            foreach ($products as $product):
                ?>
                    <tr>
                        ...
                        <td class="td-none">
                            <a href="update.php?id=<?= $product[0] ?>">Обновить</a></td>
                    </tr>
                    <tr>
                    
                        <th><a class="new-part" href="update_analyzes.php?id=<?= $product[0] ?>">Анализы</a></th>
                        <td> NH3: <br>
                             CaO: <br>
                             pH: <br>
                             выплавка: <br>
